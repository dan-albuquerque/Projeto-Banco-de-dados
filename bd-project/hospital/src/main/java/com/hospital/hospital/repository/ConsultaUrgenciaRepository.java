...
public class ConsultaUrgenciaRepository {
        ...
        public List<ConsultaUrgencia> selectConsultaUrgenciaByMedico(String cpf) {
                return jdbcTemplate.query("SELECT * FROM consulta_urgencia WHERE fk_medico_cpf = ?",
                                consultaUrgenciaMapper,
                                cpf);
        }
        ...
        public ConsultaUrgenciaDTO selectConsultaUrgenciaDTOById(int fk_registro_urgencia_codigo, String fk_medico_cpf,
                        String fk_paciente_cpf) {
                return jdbcTemplate.queryForObject(
                                "SELECT c.data_realizacao, p.nome as paciente_nome, m.nome as medico_nome FROM consulta_urgencia c "
                                                +
        ...
        @SuppressWarnings("deprecation")
        public int addUrgencyConsultation(String pacienteCpf, String medicoCpf, String conduta, String historicoDoenca,
                        String exameFisico, String dataConsulta) {
                String sql = "CALL AddUrgencyConsultation(?, ?, ?, ?, ?, ?)";
                return jdbcTemplate.queryForObject(sql, new Object[] { pacienteCpf, medicoCpf, conduta, historicoDoenca,
                                exameFisico, dataConsulta }, Integer.class);
        }
}
