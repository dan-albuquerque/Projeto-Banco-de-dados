            ...
            <table className="table-auto border-collapse border border-gray-300">
                <thead>
                    <tr>
                        ...
                        <th className="border-b-2 border-gray-300 border-r px-5 py-2 text-sm text-left">CPF Paciente</th>
                        <th className="border-b-2 border-gray-300 border-r px-5 py-2 text-sm text-left">CPF Médico</th>
                        <th className="border-b-2 border-gray-300 border-r px-5 py-2 text-sm text-left">Código Registro</th>
                ...
                <tbody>
                    ...
                    {ConsultasUrgencia && ConsultasUrgencia.map((Consulta) => (
                        <tr key={ConsultasUrgencia.fk_medico_cpf}>
                            ...
                            <td className="border-b border-gray-300 border-r px-5 py-2 text-sm text-left">{Consulta.fk_paciente_urgencia_cpf}</td>
