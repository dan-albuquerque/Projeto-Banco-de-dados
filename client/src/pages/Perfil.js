        ...
        <div className='flex items-start w-1/2 flex-col gap-20'>
          ...
          <div className='flex flex-col gap-8'>
            ...
            <div className='flex flex-col'>
                {medico.fk_medico_cpf_gerente && <p className='text-3xl'><b>Gerente:</b> {nomeGerente}</p>}
                {medico.fk_medico_cpf_gerente === null && <p className='text-3xl'><b>Cargo:</b> gerente</p>}
            </div>
            
          </div>
          <div className='flex gap-6'>
              <button className='bg-black text-white text-xl rounded-md p-3 shadow-md transition-transform duration-200 hover:scale-105'>Ver pacientes</button>
              <button className='bg-black text-white text-xl rounded-md p-3 shadow-md transition-transform duration-200 hover:scale-105'>Ver Consultas</button>
